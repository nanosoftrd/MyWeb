                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Nanosoft is the most popular for <span class="auto-style1" style="outline : 0;">Software Development Using Java, JSP, PHP, .net, Mobile Technologies (iOS, Android, Windows)</span> framework for developing responsive Web sites.</h1>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Android & iOS approach</h1>
                                    <h2 class="animation animated-item-2">Software Development Using Java, JSP, PHP, .net, Mobile Technologies (iOS, Android, Windows)</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
    ...
    <section id="feature">
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>Services</h2>
                <p class="lead">Easy to use, Responsive features, Android &amp; iOS Apps and Web Development&nbsp; approach is compatible with all modern browsers</p>
            </div>
